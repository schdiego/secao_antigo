...
namespace Front_End
{
    class FrontEnd
    {
        ...
        public static void conferirTbox_Leave(TextBox tBox, string mensagem, string arred, bool isInt, bool aceptZero)
        {
            //define separador
            char separador2 = '.';
            if (separador == ',')
            ...
            else
            {
                ...
                else
                {
                    if (aceptZero == true)
                    {
                        ...
                        {
                            if (Regex.IsMatch(tBox.Text, "[^0-9,.]"))
                            {
                            ...
                            else
                            {
                                if (tBox.Text != "0")
                                {
                                    ...
                                    {
                                        tBox.Text = "0";
                                        conferirTbox_Leave(tBox, mensagem, arred, isInt, aceptZero);
                                    }
                                    else
                                    {
